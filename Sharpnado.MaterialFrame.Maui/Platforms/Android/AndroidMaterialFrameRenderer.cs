...
namespace Sharpnado.MaterialFrame.Maui.Droid
{
    ...
    public partial class AndroidMaterialFrameRenderer : FrameRenderer
    {
        ...
        {
            _mainDrawable?.SetCornerRadius(_context.ToPixels(MaterialFrame.CornerRadius));
            _acrylicLayer?.SetCornerRadius(_context.ToPixels(MaterialFrame.CornerRadius));
            _realtimeBlurView?.SetCornerRadius(_context.ToPixels(MaterialFrame.CornerRadius));
        }
        ...
        private void SetAcrylicTheme()
        {
            ...
            {
                layer.SetLayerInsetTop(1, (int)_context.ToPixels(2));
            }
            else
            {
